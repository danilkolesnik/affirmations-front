...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/Adapty/Adapty.bundle"
  ...
  install_resource "${PODS_ROOT}/../../node_modules/react-native-adapty/lib/ios/CrossplatformVersion.plist"
  install_resource "${PODS_ROOT}/../../node_modules/react-native-adapty/lib/ios/Pods/Pods.xcodeproj/xcuserdata/jimpunster.xcuserdatad/xcschemes/xcschememanagement.plist"
fi
