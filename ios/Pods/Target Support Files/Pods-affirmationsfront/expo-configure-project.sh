...
with_node \
  ...
  --target "/Users/filicaliva/Documents/dev/freelance_Diana/affirmation/app/ios/Pods/Target Support Files/Pods-affirmationsfront/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-apple-authentication" "expo-application" "expo-asset" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-web-browser"
